...
export function HeroBanner() {
  return (
    <section className="px-4 pt-6 md:px-6">
      <div className="relative overflow-hidden rounded-3xl bg-hero p-6 shadow-card md:p-10">
        {/* decorative shapes */}
        ...
        <div className="relative z-10 max-w-[80%] md:max-w-[62%]">
          ...
          <div className="mt-4 flex flex-wrap gap-x-4 gap-y-1 text-[12px] font-semibold text-ink/75">
